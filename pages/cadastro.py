...
st.set_page_config(page_title="Carvalho Ferreira | Painel", layout="wide")
...
if codigo_busca:
    if st.sidebar.button("📂 Materiais / Compartilhar", use_container_width=True, key="btn_materiais_atalho"):
        st.switch_page("pages/materiais.py")
else:
    st.sidebar.button("📂 Materiais / Compartilhar", use_container_width=True, disabled=True, help="Busque um imóvel primeiro")
