...
def valor_positivo(valor):
    ...
    Zero não aparece em itens como suítes,
    dormitórios, banheiros e vagas.
    """
...
def gerar_pdf(codigo_imovel):
    ...
    try:
        ...
        print(
            f"Erro ao listar/baixar fotos: {e}",
            flush=True
        )
    ...
    html_rendered = Template(
        ...
        fonte_manrope_regular=fonte_local(
            "MANROPE",
            "Manrope-Regular.ttf"
        ),
        ...
        # IMPORTANTE:
        # mantém exatamente a coluna OBS EXTRAS
        observacao=get_dado(
            dados,
            "OBS EXTRAS"
        ),
