...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .valor-imovel { position: fixed; top: 400px; left: 50%; transform: translateX(-50%); width: 40px;z-index: 100; font-size: 24pt; font-weight: 600; color: #F7F5F0; letter-spacing: 0.8px; text-align: center; }
